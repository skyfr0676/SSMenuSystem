// -----------------------------------------------------------------------
// <copyright file="Parameters.cs" company="Skyfr0676 and Redforce04">
...
public static class Parameters
{
    ...
    /// <returns>An instance of <see cref="ServerSpecificSettingBase"/> That contains synced value, or null if not found.</returns>
    ...
    public static List<ServerSpecificSettingBase> GetMenuSpecificSyncedParameters<T>(ReferenceHub referenceHub)
        where T : Menu
    {
        List<ServerSpecificSettingBase> toReturn = new ();
    ...
    /// <summary>
    /// Sync all parameters for all menus for <see cref="ReferenceHub"/>.
    /// </summary>
    /// <param name="hub">The target hub.</param>
    /// <returns>An enumerator for <see cref="Timing.RunCoroutine(System.Collections.Generic.IEnumerator{float})"/>.</returns>
